                            ...
                            <div key={index}>
                                <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-muted-foreground mt-1">15/01/2024</p>
                                    </div>
                                </div>
                                <Progress value={project.progress} className="h-2" />
                                <p className="text-right text-sm text-muted-foreground mt-1">{project.progress}%</p>
                            </div>
                        ))}
                    </CardContent>
                </Card>
                            ...
                            <div key={index} className="flex items-start gap-4 border-l-2 border-green-500 pl-4">
                                <div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <p className="text-xs text-muted-foreground ml-auto">{msg.time}</p>
                                    </div>
